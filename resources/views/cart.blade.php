                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        <a href="#">
                                            ...
                                            <img style="height: 100px" src="{{ asset('/storage') }}/{{ $pdt->model->image }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                        </a>
                                        <div class="cart-product-content">
                                            <p class="cart-author"><?php echo substr($pdt->name,0, 40) ?>...</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <input title="Qty" class="email input-text qty text" type="text" value="{{ $pdt->qty }}" readonly>
